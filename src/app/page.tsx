...
const plans = [
  ...
  },
  {
    ...
    price: "R$ 497,90",
    period: "por mês",
    description: "Sua blindagem gerencial de base. Evite prejuízos enormes testando decisões no nosso board antes de lançá-las.",
    features: [
      "2 Mentorias profundas no mês",
      "Sessões robustas de 40 minutos",
      "Interação face a face com 5 Conselheiros",
      "Planos Táticos em PDF (Agente Marco)",
      "Gravação visual e transcrição vitalícia",
    ],
    cta: "Convocar Reunião de Diretoria",
    popular: false,
  },
  {
    ...
    price: "R$ 1.197,90",
    period: "por mês",
    description: "Uma fração insignificante do risco de errar. Seu conselho empresarial pessoal operando em ritmo de elite, sob demanda.",
    features: [
      "5 Batalhas Intelectuais no mês",
      "Sessões dinâmicas de 40 minutos",
      "Agente Marco com RAG (Pesquisa Setorial)",
      "Análise profunda de PDFs e Balanços",
      "Respostas em Cluster Prioritário da IA",
      "Acesso compartilhado simultâneo com sócios",
    ],
    cta: "Assumir a Cadeira de Presidente",
    popular: true,
  },
];
